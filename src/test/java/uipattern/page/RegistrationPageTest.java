...
public class RegistrationPageTest {
    ...
    String name = "Alena"+ random.nextInt(1000)+"@yandex.ru";
    String email = "Alena"+ random.nextInt(1000)+"@yandex.ru";
    String password = "Alena"+ random.nextInt(1000)+"@yandex.ru";
    String passwordFail = "A"+ random.nextInt(100);
